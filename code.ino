...
{ //float d,o2;
  ...
  float d  = dcalc(); //function for distance calculate
 ...
 /*
   ...
   */
   ...
   if (d >180 && d <100  )     // to check if the distance is less than threshold
      {
   ...
   else if( d <=180 && d >=100)
      {
          ...
          float o2 = Oxygenperc();   //function for oxygen calculate
          float Ms = methane();
          if (o2 >= 19.5 && Ms < 399)     // to check if the Oxygen is less than threshold
              {
                 ...
                 // digitalWrite(LG, LOW);
                  ...
                  Serial.print(Ms);
                  Serial.print(" \n");
                  Serial.println("THE MANHOLE IS SAFE FOR OPERATION WORK CAN BE DONE  \n \n");
                  //calltimer();
                  digitalWrite(LR, LOW);
                  delay(5000);
              }
          ...
          {       digitalWrite(LR, HIGH);
                  Serial.print("THe methane is too high pls clean the manhole \n \n");
          }
...
{   /*int x =millis();
    ...
    y=y/(60*1000);
    Serial.println("");
    Serial.println("The time for which the manhole was working was");
    Serial.println(y);
